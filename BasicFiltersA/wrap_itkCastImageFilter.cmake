WRAP_CLASS("itk::CastImageFilter" POINTER_WITH_SUPERCLASS)
  FOREACH(d ${WRAP_ITK_DIMS})
    ...
    WRAP_TEMPLATE_IF_TYPES("${ITKM_IUL${d}}${ITKM_IUC${d}}" "${ITKT_IUL${d}},${ITKT_IUC${d}}" "UL") # needed to save in 8 bits
    ...
    WRAP_TEMPLATE_IF_TYPES("${ITKM_IUS${d}}${ITKM_IUL${d}}" "${ITKT_IUS${d}},${ITKT_IUL${d}}" "US;UL")
    ...
    WRAP_TEMPLATE_IF_TYPES("${ITKM_IUC${d}}${ITKM_IUL${d}}" "${ITKT_IUC${d}},${ITKT_IUL${d}}" "UC;UL")
    ...
    WRAP_TEMPLATE_IF_TYPES("${ITKM_ISL${d}}${ITKM_IUL${d}}" "${ITKT_ISL${d}},${ITKT_IUL${d}}" "SL;UL")
    ...
    WRAP_TEMPLATE_IF_TYPES("${ITKM_ISS${d}}${ITKM_IUL${d}}" "${ITKT_ISS${d}},${ITKT_IUL${d}}" "SS;UL")
    ...
    WRAP_TEMPLATE_IF_TYPES("${ITKM_ISC${d}}${ITKM_IUL${d}}" "${ITKT_ISC${d}},${ITKT_IUL${d}}" "SC;UL")
