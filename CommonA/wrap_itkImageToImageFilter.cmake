WRAP_CLASS("itk::ImageToImageFilter" POINTER)
  FOREACH(d ${WRAP_ITK_DIMS})
    ...
    WRAP_TYPES("${ITKM_ID${d}}${ITKM_IUL${d}}" "${ITKT_ID${d}},${ITKT_IUL${d}}" "D") # needed for watershed
    ...
    WRAP_TYPES("${ITKM_IF${d}}${ITKM_IUL${d}}" "${ITKT_IF${d}},${ITKT_IUL${d}}" "F") # needed for watershed
    ...
    WRAP_TYPES("${ITKM_IUL${d}}${ITKM_IUS${d}}" "${ITKT_IUL${d}},${ITKT_IUS${d}}" "US") # needed for relabel component
    WRAP_TYPES("${ITKM_IUL${d}}${ITKM_IUC${d}}" "${ITKT_IUL${d}},${ITKT_IUC${d}}" "") # needed to save in 8 bits and for relabel component
    WRAP_TYPES("${ITKM_IUL${d}}${ITKM_ISL${d}}" "${ITKT_IUL${d}},${ITKT_ISL${d}}" "SL") # needed for relabel component
    WRAP_TYPES("${ITKM_IUL${d}}${ITKM_ISS${d}}" "${ITKT_IUL${d}},${ITKT_ISS${d}}" "SS") # needed for relabel component
    WRAP_TYPES("${ITKM_IUL${d}}${ITKM_ISC${d}}" "${ITKT_IUL${d}},${ITKT_ISC${d}}" "SC") # needed for relabel component
    
    WRAP_TYPES("${ITKM_IUS${d}}${ITKM_ID${d}}"  "${ITKT_IUS${d}},${ITKT_ID${d}}"  "US;D")
    WRAP_TYPES("${ITKM_IUS${d}}${ITKM_IF${d}}"  "${ITKT_IUS${d}},${ITKT_IF${d}}"  "US;F")
    WRAP_TYPES("${ITKM_IUS${d}}${ITKM_IUL${d}}" "${ITKT_IUS${d}},${ITKT_IUL${d}}" "US") # needed for watershed
    ...
    WRAP_TYPES("${ITKM_IUC${d}}${ITKM_IUL${d}}" "${ITKT_IUC${d}},${ITKT_IUL${d}}" "UC") # needed for watershed
    ...
    WRAP_TYPES("${ITKM_ISL${d}}${ITKM_IUL${d}}" "${ITKT_ISL${d}},${ITKT_IUL${d}}" "SL") # needed for watershed
    ...
    WRAP_TYPES("${ITKM_ISS${d}}${ITKM_IUL${d}}" "${ITKT_ISS${d}},${ITKT_IUL${d}}" "SS") # needed for watershed
    ...
    WRAP_TYPES("${ITKM_ISC${d}}${ITKM_IUL${d}}" "${ITKT_ISC${d}},${ITKT_IUL${d}}" "SC") # needed for watershed
    ...
    FOREACH(d2 ${WRAP_ITK_DIMS})
      IF (NOT "${d}" EQUAL "${d2}") # this was already taken care of elsewhere
        WRAP_TYPES("${ITKM_ID${d}}${ITKM_ID${d2}}"   "${ITKT_ID${d}},${ITKT_ID${d2}}"   "D")
        WRAP_TYPES("${ITKM_IF${d}}${ITKM_IF${d2}}"   "${ITKT_IF${d}},${ITKT_IF${d2}}"   "F")
        WRAP_TYPES("${ITKM_IUL${d}}${ITKM_IUL${d2}}" "${ITKT_IUL${d}},${ITKT_IUL${d2}}" "UL")
        WRAP_TYPES("${ITKM_IUS${d}}${ITKM_IUS${d2}}" "${ITKT_IUS${d}},${ITKT_IUS${d2}}" "US")
        WRAP_TYPES("${ITKM_IUC${d}}${ITKM_IUC${d2}}" "${ITKT_IUC${d}},${ITKT_IUC${d2}}" "UC")
        WRAP_TYPES("${ITKM_ISL${d}}${ITKM_ISL${d2}}" "${ITKT_ISL${d}},${ITKT_ISL${d2}}" "SL")
        WRAP_TYPES("${ITKM_ISS${d}}${ITKM_ISS${d2}}" "${ITKT_ISS${d}},${ITKT_ISS${d2}}" "SS")
        WRAP_TYPES("${ITKM_ISC${d}}${ITKM_ISC${d2}}" "${ITKT_ISC${d}},${ITKT_ISC${d2}}" "SC")
    ...
    # int -> RGB
    WRAP_TYPES("${ITKM_IUC${d}}${ITKM_IRGBUC${d}}" "${ITKT_IUC${d}},${ITKT_IRGBUC${d}}" "UC;RGBUC")
    WRAP_TYPES("${ITKM_IUS${d}}${ITKM_IRGBUS${d}}" "${ITKT_IUS${d}},${ITKT_IRGBUS${d}}" "US;RGBUS")

    # RGB -> int
    WRAP_TYPES("${ITKM_IRGBUS${d}}${ITKM_IUS${d}}" "${ITKT_IRGBUS${d}},${ITKT_IUS${d}}" "US;RGBUS")
    WRAP_TYPES("${ITKM_IRGBUC${d}}${ITKM_IUC${d}}" "${ITKT_IRGBUC${d}},${ITKT_IUC${d}}" "UC;RGBUC")

    # RGB -> RGB
    WRAP_TYPES("${ITKM_IRGBUS${d}}${ITKM_IRGBUS${d}}" "${ITKT_IRGBUS${d}},${ITKT_IRGBUS${d}}" "RGBUS")
    WRAP_TYPES("${ITKM_IRGBUC${d}}${ITKM_IRGBUC${d}}" "${ITKT_IRGBUC${d}},${ITKT_IRGBUC${d}}" "RGBUC")
