  ...
  FOREACH(d1 ${WRAP_DIMS})
    FOREACH(d2 ${WRAP_DIMS})
      IF("${d1}" GREATER "${d2}")
        ...
        COND_WRAP("${ITKM_IUC${d1}}${ITKM_IUC${d2}}" "${ITKT_IUC${d1}},${ITKT_IUC${d2}}" "") # needed to write in 8 bits
        ...
        COND_WRAP("${ITKM_IRGBUC${d1}}${ITKM_IRGBUC${d2}}" "${ITKT_IRGBUC${d1}},${ITKT_IRGBUC${d2}}" "RGBUC")
        COND_WRAP("${ITKM_IRGBUS${d1}}${ITKM_IRGBUS${d2}}" "${ITKT_IRGBUS${d1}},${ITKT_IRGBUS${d2}}" "RGBUS")
      ENDIF("${d1}" GREATER "${d2}")
    ENDFOREACH(d2)
  ENDFOREACH(d1)
END_WRAP_CLASS()
