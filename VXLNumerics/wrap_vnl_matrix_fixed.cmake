...
WRAP_CLASS("vnl_matrix_fixed")
  ...
  WRAP("${ITKM_D}_2_6" "${ITKT_D},2,6")
  WRAP("${ITKM_D}_3_12" "${ITKT_D},3,12")
  WRAP("${ITKM_D}_3_3" "${ITKT_D},3,3")
  WRAP("${ITKM_D}_3_4" "${ITKT_D},3,4")
  WRAP("${ITKM_D}_4_3" "${ITKT_D},4,3")
  WRAP("${ITKM_D}_4_4" "${ITKT_D},4,4")
  WRAP("${ITKM_F}_3_3" "${ITKT_F},3,3")
END_WRAP_CLASS()
