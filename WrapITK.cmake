...
MACRO(WRAP_VECTOR_REAL_DIMS SIZE DIMS)
  ...
  FOREACH(d ${DIMS})
    SET(ddims ${ddims} "${d}${d}")
  ENDFOREACH(d)
  WRAP_TYPES_DIMS(${SIZE} "VF;VD" "${ddims}")
ENDMACRO(WRAP_VECTOR_REAL_DIMS SIZE)

MACRO(WRAP_VECTOR_REAL SIZE)
  WRAP_VECTOR_REAL_DIMS(${SIZE} "2;3")
