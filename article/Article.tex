...
\begin{itemize}
  ...
  \item or even with an instance of class used as template parameter: \verb$itk.ImageFileReader[image]$.
\end{itemize}
...
which make ITK less verbose, and a lots more easy to use in the interpreter.
     ...
     \subsubsection{Python specific functions}
