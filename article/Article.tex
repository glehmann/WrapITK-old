...
by swig like perl, ruby, ocaml and others.
...
\verb$darcs$ allow to easily contribute to WrapITK, by sending patch by email with
...
A web interface (\url{http://auriga.wearlab.de/~alb/darcsweb/}) for the WrapITK darcs
...
Thank to Charl P. Botha for is help to debug WrapITK on windows plateform and for the
