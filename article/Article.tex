...
\begin{itemize}
  ...
  \item make wchoice of template arguments explicit. It should be easy to understand
...
\verb$MedianImageFilter$. Let see that example in detail.
...
Then, several \verb$WRAP_IMAGE_FILTER_*$ macros are called. They are convenient macro which create
a set of template argument.
