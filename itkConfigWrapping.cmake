  ...
  IF(WRAP_ITK_TCL)
    ...
    IF(ITK_SWIG_FILE)
      ADD_CUSTOM_COMMAND(
        ...
        STRING(REGEX REPLACE ".i" ".tcl" swig_language_file "${ITK_SWIG_FILE}")
        INSTALL_FILES("${WRAP_ITK_INSTALL_LOCATION}/Tcl-SWIG" FILES "${LIBRARY_OUTPUT_PATH}/${CMAKE_CFG_INTDIR}/${swig_language_file}")
    ENDIF(ITK_SWIG_FILE)
  ENDIF(WRAP_ITK_TCL)
  ...
  IF(WRAP_ITK_PERL)
    ...
    IF(ITK_SWIG_FILE)
      ADD_CUSTOM_COMMAND(
        ...
        OUTPUTS ${WRAP_FILE}
        DEPENDS ${ITK_SWIG_FILE} ${CSWIG})
        STRING(REGEX REPLACE ".i" ".pl" swig_language_file "${ITK_SWIG_FILE}")
        INSTALL_FILES("${WRAP_ITK_INSTALL_LOCATION}/Perl-SWIG" FILES "${LIBRARY_OUTPUT_PATH}/${CMAKE_CFG_INTDIR}/${swig_language_file}")
    ENDIF(ITK_SWIG_FILE)
  ENDIF(WRAP_ITK_PERL)
  ...
  IF(WRAP_ITK_PYTHON)  
    ...
    IF(ITK_SWIG_FILE)
      ADD_CUSTOM_COMMAND(
        ...
        OUTPUTS ${WRAP_FILE}
        DEPENDS ${ITK_SWIG_FILE} ${CSWIG})
        STRING(REGEX REPLACE ".i" ".py" swig_language_file "${ITK_SWIG_FILE}")
        INSTALL_FILES("${WRAP_ITK_INSTALL_LOCATION}/Python-SWIG" FILES "${LIBRARY_OUTPUT_PATH}/${CMAKE_CFG_INTDIR}/${swig_language_file}")
    ENDIF(ITK_SWIG_FILE)
  ENDIF(WRAP_ITK_PYTHON)
  ...
  IF(WRAP_ITK_JAVA)  
    ...
    IF(ITK_SWIG_FILE)
      ADD_CUSTOM_COMMAND(
        ...
        OUTPUTS ${WRAP_FILE}
        DEPENDS ${ITK_SWIG_FILE} ${CSWIG})
        STRING(REGEX REPLACE ".i" ".java" swig_language_file "${ITK_SWIG_FILE}")
        INSTALL_FILES("${WRAP_ITK_INSTALL_LOCATION}/Java-SWIG" FILES "${LIBRARY_OUTPUT_PATH}/${CMAKE_CFG_INTDIR}/${swig_language_file}")
    ENDIF(ITK_SWIG_FILE)
  ENDIF(WRAP_ITK_JAVA)
