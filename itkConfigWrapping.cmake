...
SET(ITK_SWG_FILES "${ITK_SOURCE_DIR}/Wrapping/CSwig/itk.swg")
...
SET(SWIG_INC
  ...
  ${ITK_SOURCE_DIR}/Wrapping/CSwig/CommonA
  ${ITK_SOURCE_DIR}/Wrapping/CSwig/CommonB
  ${ITK_SOURCE_DIR}/Wrapping/CSwig/VXLNumerics
  ${ITK_SOURCE_DIR}/Wrapping/CSwig/Numerics
  ${ITK_SOURCE_DIR}/Wrapping/CSwig/BasicFiltersA
  ${ITK_SOURCE_DIR}/Wrapping/CSwig/BasicFiltersB
  ${ITK_SOURCE_DIR}/Wrapping/CSwig/IO
  ${ITK_SOURCE_DIR}/Wrapping/CSwig/SpatialObject
  ${ITK_SOURCE_DIR}/Wrapping/CSwig/Algorithms
  )
...
SET(ITK_SWIG_DEFAULT_LIB ${ITK_SOURCE_DIR}/Utilities/CableSwig/Swig/Lib )
...
MACRO(ITK_WRAP_LIBRARY SRCS LIBRARY_NAME DIRECTORY DEPEND_LIBRARY EXTRA_SOURCES ITK_LINK_LIBRARIES MASTER_IDX SOURCE_DIR BINARY_DIR)
  ...
  CONFIGURE_FILE(
    ${ITK_SOURCE_DIR}/Wrapping/CSwig/Master.mdx.in
  ...
  ENDFOREACH(dir)
  CONFIGURE_FILE(${ITK_SOURCE_DIR}/Wrapping/CSwig/SwigInc.txt.in ${SWIG_INC_FILE}
    @ONLY IMMEDIATE)
